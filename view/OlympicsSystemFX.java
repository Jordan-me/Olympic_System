...
public class OlympicsSystemFX implements AbstractOlympicsView {
	...
	public void buildSecondSession() {
		...
		tab1 = new Tab("Competition management system");
		tab2 = new Tab("Countries DataBase");
		buildTab2();
...
//		spRoot.getChildren().add(vbSecondSession);
		tab1.setContent(vbSecondSession);
		tabPane.getTabs().add(tab1);
		tabPane.getTabs().add(tab2);

		Scene seconSessionScene = new Scene(tabPane, 1500, 400);
